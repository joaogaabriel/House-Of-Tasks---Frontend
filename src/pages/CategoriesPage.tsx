...
import { CategoryService } from "../services/tasks/CategoryService";
...
export default function CategoriesPage() {
  ...
  const processRowUpdate = async (newRow: GridRowModel) => {
    try {
      ...
      if (newRow.isNew) {
        const data = await CategoryService.create(newRow);
        ...
        const data = await CategoryService.update(newRow.id, newRow);
        updatedRow = data;
  ...
  const safeSetRows = (
    ...
    setRows((old) => updater(old) as Category[]);
  };
